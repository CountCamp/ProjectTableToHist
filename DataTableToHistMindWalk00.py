...
class DataToHistMindWalk00(Scene):
    def construct(self):
...
# To run the script:
# manim -qm --disable_caching DataTableToHistMindWalk00.py DataToHistMW00 | tee outputMW00.txt
# manim -qk -p --disable_caching DataTableToHistMindWalk.py DataToHistMindWalk00
